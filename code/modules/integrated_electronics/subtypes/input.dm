...
/obj/item/integrated_circuit/input/microphone
	...
	var/languages_understood = list(LANGUAGE_HUMAN_EURO, LANGUAGE_HUMAN_CHINESE, LANGUAGE_HUMAN_ARABIC, LANGUAGE_HUMAN_INDIAN, LANGUAGE_HUMAN_IBERIAN, LANGUAGE_HUMAN_RUSSIAN, LANGUAGE_HUMAN_SELENIAN)
...
/obj/item/integrated_circuit/input/microphone/hear_talk(var/mob/living/M as mob, text, verb, datum/language/speaking)
	...
	if((M && text) && speaking)
		if(!(speaking.flags && invalid_flags))
			if(speaking in languages_understood)
				translated = TRUE
			else
...
/obj/item/integrated_circuit/input/microphone/binary
	name = "binary modulating microphone"
